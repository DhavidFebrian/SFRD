# 📱 SFRD — Schedule Foto RWC (Version 8.6.3)

<div align="center">
  <img src="https://img.shields.io/badge/Platform-Android-green?style=for-the-badge&logo=android" />
  <img src="https://img.shields.io/badge/Version-8.6.3-blue?style=for-the-badge&logo=github" />
...
1. **Ubah Versi Sebelum Build**:  
   ...
   ```kotlin
   defaultConfig {
       versionCode = 863    // Naikkan kode (misal 863)
    versionName = "8.6.3" // Samakan dengan nama tag rilis target (misal 8.6.3)
   }
   ```
2. **Kompilasi APK**:  
...
3. **Push Kode Terupdate ke GitHub**:
   ```bash
   git add .
    git commit -m "Release version 8.6.3"
   git push origin main
   ```
4. **Buat Release di GitHub**:
   * Buka menu **Releases -> Draft a new release** di GitHub.
    * Buat tag baru dengan nama tag yang sama persis seperti versi tadi (contoh: **`8.6.3`** atau **`v8.6.3`**).
