# 📱 SFRD — Schedule Foto RWC (Version 5.8.4)

<div align="center">
  <img src="https://img.shields.io/badge/Platform-Android-green?style=for-the-badge&logo=android" />
  <img src="https://img.shields.io/badge/Version-5.8.4-blue?style=for-the-badge&logo=github" />
...
1. **Ubah Versi Sebelum Build**:  
   ...
   ```kotlin
   defaultConfig {
       versionCode = 584    // Naikkan kode (misal 584)
       versionName = "5.8.4" // Samakan dengan nama tag rilis target (misal 5.8.4)
   }
   ```
2. **Kompilasi APK**:  
...
3. **Push Kode Terupdate ke GitHub**:
   ```bash
   git add .
   git commit -m "Release version 5.8.4"
   git push origin main
   ```
4. **Buat Release di GitHub**:
   * Buka menu **Releases -> Draft a new release** di GitHub.
   * Buat tag baru dengan nama tag yang sama persis seperti versi tadi (contoh: **`5.8.4`** atau **`v5.8.4`**).
