# 📱 SFRD — Schedule Foto RWC (Version 8.6.4)

<div align="center">
  <img src="https://img.shields.io/badge/Platform-Android-green?style=for-the-badge&logo=android" />
  <img src="https://img.shields.io/badge/Version-8.6.4-blue?style=for-the-badge&logo=github" />
...
1. **Ubah Versi Sebelum Build**:  
   ...
   ```kotlin
   defaultConfig {
       versionCode = 864    // Naikkan kode (misal 864)
    versionName = "8.6.4" // Samakan dengan nama tag rilis target (misal 8.6.4)
   }
   ```
2. **Kompilasi APK**:  
...
3. **Push Kode Terupdate ke GitHub**:
   ```bash
   git add .
    git commit -m "Release version 8.6.4"
   git push origin main
   ```
4. **Buat Release di GitHub**:
   * Buka menu **Releases -> Draft a new release** di GitHub.
    * Buat tag baru dengan nama tag yang sama persis seperti versi tadi (contoh: **`8.6.4`** atau **`v8.6.4`**).
