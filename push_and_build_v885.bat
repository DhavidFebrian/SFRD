@echo off
title SFRD v8.8.5 - Git Push + Build APK
color 0B
...
copy /Y "app\build\outputs\apk\debug\app-debug.apk" "SFRD-v8.8.5.apk"

echo.
echo =====================================
echo   SELESAI!
echo   APK: SFRD-v8.8.5.apk
echo =====================================
echo.
pause
